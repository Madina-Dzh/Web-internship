...
<body class="site">
    ...
    <div class="container">
        ...
        <div class="main-wrapper">
            <!-- Вкладки -->
            <div class="tabs">
                <a href="<?php echo PRACTICES_URL; ?>active-practices.php" class="tab active">Активные</a>
                <a href="<?php echo PRACTICES_URL; ?>expired-practices.php" class="tab">Архив</a>
                <a href="<?php echo PRACTICES_URL; ?>planning-practices.php" class="tab">Планирование</a>
            </div>
